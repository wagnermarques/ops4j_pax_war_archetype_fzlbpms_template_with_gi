...
A=jsx3.util.Logger.getLogger(o.jsxclass.getName());o.PERSIST_SESSION=1;o.PERSIST_INDEFINITE=2;g.o0=null;g.dU=null;g.zH=null;g.init=function(e,n){if(n==null)n=2;this.o0=e;this.dU=n;var
...
fb=this.KX();var
pa=this.o0.getSettings();var
ga=pa.get(ub.b,ub.c);var
ka=pa.get(ub.b,ub.d);this.o0.deleteCookie(fb,ka,ga);};g.save=function(){var
S=o.tD(this.zH);S=S.replace(ub.e,ub.f);S=S.replace(ub.g,ub.h);S=S.replace(ub.i,ub.j);S=S.replace(ub.k,ub.l);S=escape(S);var
Ha=S.length;if(Ha>4096)A.warn(jsx3._msg(ub.m,Ha));this.Rw(S);};g.KX=function(){return this.o0.getEnv(ub.n)+(this.dU==1?ub.o:ub.p);};g.CI=function(){var
xb=this.KX();var
ha=this.o0.getCookie(xb,true);if(ha){ha=ha.replace(ub.e,ub.q);ha=ha.replace(ub.g,ub.r);ha=unescape(ha);}return ha;};g.Rw=function(e){var
Qa=this.KX();var
qb=this.o0.getSettings();var
gb=qb.get(ub.b,ub.c);var
za=qb.get(ub.b,ub.d);var
Aa=new
Date();var
ab=this.dU==1?null:new
Date(Aa.getFullYear()+1,Aa.getMonth(),Aa.getDate());this.o0.setCookie(Qa,e,ab,za,gb,null,true);};o.uw=function(r){if(!r)return {};var
Xa=new
...
jsx3.Exception(jsx3._msg(ub.H,Nb));Ga.setAttribute(ub.t,l);q.appendChild(Ga);};g.toString=function(){return this.jsxsuper()+this.o0.getAppPath();};});jsx3.UserSettings=jsx3.app.UserSettings;
