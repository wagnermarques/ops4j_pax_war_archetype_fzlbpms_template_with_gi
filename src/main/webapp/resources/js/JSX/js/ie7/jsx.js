...
ub={a:"jsxabspath",b:"jsxhomepath",c:"jsxscriptapppath",d:"JSXAPPS",e:"/",f:"..",g:"jsx",h:"JSX",i:"jsxuser",j:"GI_Builder/",k:"function",l:"jsxurirslv",m:"3.6",n:"strURI",o:"bRel"};p.BV={};p.register=function(b,j){p.BV[b]=j;};p.UR=function(){if(this.V0==null)this.V0=new
jsx3.net.URI(jsx3.getEnv(ub.a));return this.V0;};p.FV=function(){var
wa=jsx3.getEnv(ub.b);if(wa==null)return new
jsx3.net.URI(jsx3.getEnv(ub.c));if(this.my==null)this.my=new
jsx3.net.URI(wa);return this.my;};p.DEFAULT=p.jsxclass.newInnerClass();p.DEFAULT.resolveURI=function(b){var
...
db=k.NC[H];if(gb!=null&&gb.isLoggable(5))gb.debug(ub.T+w+ub.I+T+ub.F);if(db[w]!=null){T[w]=db[w];delete db[w];}else T[w]=null;}}catch(Kb){if(gb!=null&&gb.isLoggable(5))gb.debug(ub.J+e,jsx3.NativeError.wrap(Kb));k._deregisterWindow(E);H--;}};k.gG=function(e,d){return d==ub.a||d==ub.r||d==ub.s?e:e.document;};k.cW=function(j){return j!=ub.a;};k.l1=function(m){return m!=ub.a;};k.cp=function(m){return m==ub.a||m==ub.r;};a.init=function(c,q){this.yq=c;if(q)this._clone=jsx3.clone(c);};a.yh=function(){if(this._clone==null)this._clone=jsx3.clone(this.yq);this._clone._jsxky=true;};k.wrap=function(f,e){return f instanceof k?f:new
...
m(E):null;}if(Jb)Jb.setProperty(ub.j,Ib);return pa;};a.fx=function(d){if(d==null){return this.bW.ownerDocument;}else if(d==1){var
...
cb=new
jsx3.xml.Template(n);if(f)cb.setParams(f);return cb[d?ub.l:ub.m](this);};m.EE=function(){};m.EE.prototype.toString=function(){return ub.n+this.code+ub.o+(typeof this.description!=ub.p?ub.q+this.description:ub.b);};a.Dk=function(n,q){if(this.dN==null)this.dN=new
m.EE();this.dN.code=n;this.dN.description=q;};a.getError=function(){if(!this.dN)this.Dk(0);return this.dN;};a.hasError=function(){return this.dN!=null&&this.dN.code!=0;};a.getOwnerDocument=function(){return this.bW?new
jsx3.xml.Document(this.fx()):null;};m.getVersion=function(){return ub.r;};});jsx3.Entity=jsx3.xml.Entity;jsx3.Class.defineClass("jsx3.xml.Entity.List",jsx3.util.List,null,function(o,m){var
ub={a:"Not implemented",b:"[",c:"]"};var
la=jsx3.Exception;m.init=function(k){this.jsxsuper(null,true);this.p6=k;};m.get=function(s){var
va=this.p6[s];return va!=null?new
...
o(arguments.length>1?this.p6.slice(h,e):this.p6.slice(h));};m.toString=function(){return ub.b+this.toArray()+ub.c;};m.clone=function(){return new
o(this.p6.concat());};m.toArray=function(){var
ca=this.size();var
qb=new
Array(ca);for(var
Ia=0;Ia<ca;Ia++)qb[Ia]=this.get(Ia);return qb;};});jsx3.Class.defineClass("jsx3.xml.Entity.ChildIterator",null,[jsx3.util.Iterator],function(c,g){g.init=function(n,f){this.WU=n;this.ty=0;this.Ny=f;this.i6();this.bW=null;};g.next=function(){if(!this._next)return null;if(this.bW){this.bW.init(this._next);}else this.bW=new
...
H=Oa[this.ty];if(H.nodeType==1||this.Ny&&(H.nodeType==3||H.nodeType==4))this._next=H;this.ty++;}};});jsx3.Class.defineClass("jsx3.xml.Entity.SelectIterator",null,[jsx3.util.Iterator],function(d,h){h.init=function(l){this.pw=l;this.x2=0;this.bW=null;};h.next=function(){var
E=this.pw[this.x2++];if(!E)return null;if(this.bW){this.bW.init(E);}else this.bW=new
jsx3.xml.Entity(E);return this.bW;};h.hasNext=function(){return this.pw&&this.x2<this.pw.length;};});jsx3.Collection=jsx3.xml.Entity.List;jsx3.util.Collection=jsx3.Collection;jsx3.Class.defineClass("jsx3.net.Request",null,[jsx3.util.EventDispatcher],function(g,f){var
ub={a:"response",b:"timeout",c:"req_inst",d:"_timeoutto",e:"getAllResponseHeaders",f:"getResponseHeader",g:"statusText",h:"status",i:"req.bad_xml",j:"req.open",k:"req.err_open",l:"The HTTP ActiveX object does not appear to support setting timeouts.",m:"req.err_state",n:"hS",o:"req.err_send",p:"load.async",q:"load.sync",r:" ",s:"3.00.00"};g.STATUS_OK=200;g.STATUS_ERROR=400;g.EVENT_ON_RESPONSE=ub.a;g.EVENT_ON_TIMEOUT=ub.b;g.uV={};f.init=function(d){if(d!=null)g.uV[d]=this;try{this.QF=jsx3.getHttpInstance();}catch(Kb){throw new
...
B=false;try{if(!this.OJ)g.INSYNC=true;this.QF.send(d);if(this.OJ)this.hS=0;else delete this[ub.n];}catch(Kb){this.hS=400;g.Q2(2,jsx3._msg(ub.o,this.eE,jsx3.NativeError.wrap(Kb)));B=this;}finally{g.INSYNC=false;}if(this.OJ){if(B||this.QF.readyState==4){jsx3.sleep(function(){Ma.log(ub.p);this.publish({subject:ub.a});},null,this);}else{var
...
ub={A:"xml.err_fmt",B:"xml.unknown",C:"version",D:"encoding",E:"standalone",F:"yes",G:"xml",H:"\\b",I:'="(.*?)"',J:"i",K:"1.0",L:"<?xml",M:' version="',N:' encoding="',O:' standalone="',P:"no",Q:"?>\n",R:"<!-- ",S:" -->",T:"\n",U:"='",V:"'",W:"object",X:"SelectionNamespaces",Y:"xml.selns",Z:"([^=]*)=['\"]([^\"^']*)['\"]",_:"g",a:"response",aa:":",b:"error",ba:"http://www.w3.org/XML/1998/namespace",c:"timeout",ca:"undefined",d:"http://xsd.tns.tibco.com/gi/cxf/2006",da:"jsx",e:"jsx_xmlns",ea:"attribute::* | child::*",f:/xmlns:([^=]*)=['\"]([^\"^']*)['\"]/g,fa:"3.0.0",g:"SelectionLanguage",h:"XPath",i:"ForcedResync",j:"xml.parser",k:"MV",l:"GET",m:"*",n:"pO",o:"lw",XV:"",q:"content-type",r:/xml|xsl/i,s:"xml.doc_status",t:"xml.timeout",u:"xmlns:",v:'="',w:'"',x:" ",y:"parse",z:"0"};var
...
zb=c.getStatus();var
t=zb>=200&&zb<400;var
aa=ub.XV;if(!t)try{aa=c.getResponseHeader(ub.q);}catch(Kb){}if(t||jsx3.util.strEmpty(aa)||ub.r.test(aa)){this.loadXML(c.getResponseText());}else this.Dk(102,jsx3._msg(ub.s,this.eE,zb));};m.pO=function(p){var
...
G=new
jsx3.util.Timer(e.jsxclass,o!=null?jsx3.util.strTruncate(o,30):ub.XV,5);this.MV.loadXML(o);if(!this.X8(this.MV))this.UX(this.MV.documentElement);G.log(ub.y);}catch(Kb){this.X8(this.MV,jsx3.NativeError.wrap(Kb));}return this;};m.getSourceURL=function(){return this.eE;};m.X8=function(l,a){if(l!=null){var
...
N=this.MV.xml;if(N.charCodeAt(N.length-1)==10&&N.charCodeAt(N.length-2)==13)N=N.substring(0,N.length-2);return N;}else return this.jsxsuper();};m.getXmlVersion=function(){return this.OO(ub.C);};m.getXmlEncoding=function(){return this.OO(ub.D);};m.getXmlStandalone=function(){return this.OO(ub.E)==ub.F;};m.OO=function(c){var
v=this.MV.childNodes[0];if(v.nodeType==7&&v.nodeName==ub.G){var
_a=new
RegExp(ub.H+c+ub.I,ub.J);if(v.nodeValue.match(_a))return RegExp.$1;}return null;};m.cloneDocument=function(){return new
e(this.MV.cloneNode(true));};m.serialize=function(n,c,r){if(n===true)n=this.getXmlVersion()||ub.K;if(c===true)c=this.getXmlEncoding();var
Pa=n||c||r;if(Pa){var
ja=ub.L;if(n)ja=ja+(ub.M+n+ub.w);if(c)ja=ja+(ub.N+c+ub.w);if(r!=null)ja=ja+(ub.O+(r?ub.F:ub.P)+ub.w);ja=ja+ub.Q;var
Fa=new
Array(this.MV.childNodes.length+1);Fa[0]=ja;for(var
fb=0;fb<this.MV.childNodes.length;fb++){var
_=this.MV.childNodes[fb];if(_.nodeType!=7||_.nodeName!=ub.G){var
A=new
Ma(_);Fa[fb+1]=A.hasError()?ub.R+A+ub.S:A.toString();}}}else{var
Fa=new
Array(this.MV.childNodes.length);for(var
fb=0;fb<this.MV.childNodes.length;fb++){var
_=this.MV.childNodes[fb];var
A=new
Ma(_);Fa[fb]=A.hasError()?ub.R+A+ub.S:A.toString();if(_.nodeType==7||_.nodeName==ub.G)Fa[fb]+=ub.T;}}return Fa.join(ub.XV);};m.createDocumentElement=function(d,p){if(p){var
t=this.MV.createNode(1,d,p);}else var
t=this.MV.createElement(d);if(this.MV.documentElement!=null)this.MV.replaceChild(t,this.MV.documentElement);else this.MV.appendChild(t);this.UX(this.MV.documentElement);return new
jsx3.xml.Entity(t);};m.createProcessingInstruction=function(d,h){var
db=this.MV.createProcessingInstruction(d,h);this.MV.appendChild(db);};m.setAsync=function(q){this._jsxJF=q;return this;};m.getAsync=function(k){return Boolean(this._jsxJF);};m.setSelectionLanguage=function(c){return this;};m.getSelectionLanguage=function(){return this.MV.getProperty(ub.g);};e.Qj=function(j){var
U=[];for(var ka in j)U[U.length]=ub.u+j[ka]+ub.U+ka+ub.V;return U.join(ub.x);};m.setSelectionNamespaces=function(a){if(typeof a==ub.W)a=e.Qj(a);try{this.MV.setProperty(ub.X,a);}catch(Kb){this.Dk(113,jsx3._msg(ub.Y,a,jsx3.NativeError.wrap(Kb)));}return this;};m.getSelectionNamespaces=function(g){return this.MV.getProperty(ub.X);};m.createNamespaceAxis=function(){var
Ka=this.getRootNode();var
Ta=Ka.toString();var
pb=ub.XV;do{var
sb=new
RegExp(ub.u+ub.e+pb+ub.Z,ub._);var
B=Ta.search(sb);if(B>=0)pb=pb==ub.XV?0:pb+1;}while(B>=0);this.I7(Ka,ub.e+pb);return ub.e+pb;};m.I7=function(h,k){var
Sa=(h.cloneNode(false)).getXML();var
tb;while(tb=e.lP.exec(Sa))if(RegExp.$1!=k&&RegExp.$1!=ub.G){var
qb=h.createNode(2,k+ub.aa+RegExp.$1,e.SEARCHABLE_NAMESPACE);qb.setValue(RegExp.$2);h.setAttributeNode(qb);}else if(RegExp.$1==ub.G)jsx3.log(Sa);for(var
B=h.getChildIterator();B.hasNext();)this.I7(B.next(),k);};m.getDeclaredNamespaces=function(j){this._jsxl3={};var
Z=this.getRootNode();if(Z)this.J0(Z,{index:0},j);return this._jsxl3;};m.J0=function(b,j,r){var
ja=b.getNamespaceURI();if(ja!=ub.XV&&ja!=ub.ba){var
z;if(!this._jsxl3[ja]||r&&(z=b.getPrefix())!=ub.XV&&typeof r[z]!=ub.ca)if(z){this._jsxl3[ja]=z;}else{j.index+=1;this._jsxl3[ja]=ub.da+j.index;}}if(b.getNodeType()==1)for(var
rb=b.selectNodeIterator(ub.ea);rb.hasNext();){var
Db=rb.next();if(Db.getNodeType()==1||Db.getNodeType()==2)this.J0(Db,j,r);}};m.getNativeDocument=function(){return this.MV;};e.Q2=function(b,n){if(e.dK==null)if(jsx3.util.Logger){e.dK=jsx3.util.Logger.getLogger(e.jsxclass.getName());if(e.dK==null)return;}else return;e.dK.log(b,n);};e.getVersion=function(){return ub.fa;};});jsx3.Document=jsx3.xml.Document;jsx3.Class.defineClass("jsx3.xml.Template",null,null,function(p,s){var
...
jsx3.util.List();if(this.X3.indexOf(f)<0)this.X3.add(f);this.hM.addParameter(f,j!=null?j.toString():ub.g);};s.c1=function(j,b){var
ka=new
...
xa=jsx3.xml.Template;d.DISABLE_OUTPUT_ESCAPING=1;d.supports=function(n){return xa.supports(n);};h.init=function(k,o,c){this.rO=k;this.mY=o;this.X3=c;};h.setXML=function(n){this.rO=n;return this;};h.setXSL=function(r){this.mY=r;return this;};h.setParams=function(m){this.X3=m;return this;};h.transformToObject=function(){return this.transform(true);};h.transform=function(p){var
qa=new
xa(this.mY);if(!qa.hasError()){if(this.X3)qa.setParams(this.X3);var
...
Z=L.shift();if(Z.nodeName&&r._tn(Z)==ub.m&&Z.className==ub.K){Z.innerHTML=((((Z.innerHTML.replace(ub.L,ub.M)).replace(ub.N,ub.O)).replace(ub.P,ub.Q)).replace(ub.R,ub.S)).replace(ub.T,r.KQ);Z.removeAttribute(ub.U);}else if(Z.childNodes)L.push.apply(L,this.nodesToArray(Z.childNodes));}};r.removeOutputEscapingSpan=function(g){return g.replace(ub.V,function(p,m){return ((((m.replace(ub.L,ub.M)).replace(ub.N,ub.O)).replace(ub.P,ub.Q)).replace(ub.R,ub.S)).replace(ub.T,r.KQ);});};r.j1={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.KQ=function(f,g){var
O=r.j1[g];return O?ub.W+O+ub.X:f;};r.YN=ub.Y;r.loadImages=function(i){var
...
kb=jsx3.html;l.init=function(g){this.dw=(g.ownerDocument.selection.createRange()).duplicate();this.oK=g;};l.getStartIndex=function(){var
...
sa=this.oK.createTextRange();sa.collapse(true);sa.moveStart(ub.d,a);sa.moveEnd(ub.d,f-a);sa.select();};l.getOffsetLeft=function(){return this.dw.offsetLeft;};l.getOffsetTop=function(){return this.dw.offsetTop;};l.getText=function(){return this.dw.text;};l.setText=function(p){this.dw.text=p;};l.insertCaret=function(a){if(a==ub.e){this.dw.collapse();this.dw.select();}else throw new
