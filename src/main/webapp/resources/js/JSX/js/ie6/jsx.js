...
Eb=jsx3.html;o.init=function(e){this.dw=(e.ownerDocument.selection.createRange()).duplicate();this.oK=e;};o.getStartIndex=function(){var
...
Ja=this.oK.createTextRange();Ja.collapse(true);Ja.moveStart(ub.d,s);Ja.moveEnd(ub.d,i-s);Ja.select();};o.getOffsetLeft=function(){return this.dw.offsetLeft;};o.getOffsetTop=function(){return this.dw.offsetTop;};o.getText=function(){return this.dw.text;};o.setText=function(s){this.dw.text=s;};o.insertCaret=function(h){if(h==ub.e){this.dw.collapse();this.dw.select();}else throw new
