...
Wa=this.bW.childNodes[G];if(Wa.nodeType==3||Wa.nodeType==4)Oa[G]=Wa.nodeValue;else Oa[G]=Wa.textContent;}return Oa.join(ub.b);}else return this.bW.nodeValue;};a.setValue=function(q){if(q==null)q=ub.b;if(this.fA==1){this.removeChildren();this.appendChild(this.createNode(3,q));}else this.bW.nodeValue=q;return this;};m.eC=new
XPathEvaluator();m.RH=[XPathResult.FIRST_ORDERED_NODE_TYPE,XPathResult.ORDERED_NODE_ITERATOR_TYPE,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE];a.rt=function(n,q,g){if(typeof q==ub.l)q=jsx3.xml.Document.Qj(q);var
La=this.bW.ownerDocument;var
Xa=La.documentElement;var
ka=q?m.gs(q,Xa):m.C7(La)||m.eC.createNSResolver(Xa);var
jb=null;try{jb=m.eC.evaluate(n,this.bW,ka,m.RH[g],null);}catch(Kb){}if(g==1){var
z=null;var
...
m(jb.singleNodeValue):null;};m.C7=function(b){if(!b._jsxDc)if(b._jsxxh)b._jsxDc=m.gs(b._jsxxh);return b._jsxDc;};m.IV={};m.gs=function(l){var
Xa=m.IV[l];if(!Xa){var
jb=(new
DOMParser()).parseFromString(ub.m+l+ub.n,ub.o);Xa=m.IV[l]=m.eC.createNSResolver(jb.documentElement);}return Xa;};a.fx=function(h){if(h==null){return this.bW.ownerDocument;}else if(h==1){var
...
aa=new
jsx3.xml.Template(q);if(c)aa.setParams(c);return aa[s?ub.q:ub.r](this);};m.EE=function(){};m.EE.prototype.toString=function(){return ub.s+this.code+ub.t+(typeof this.description!=ub.u?ub.v+this.description:ub.b);};a.Dk=function(n,q){if(this.dN==null)this.dN=new
...
jsx3.xml.Document(this.fx()):null;};m.getVersion=function(){return ub.w;};});jsx3.Entity=jsx3.xml.Entity;jsx3.Class.defineClass("jsx3.xml.Entity.List",jsx3.util.List,null,function(l,p){var
ub={a:"Not implemented",b:"[",c:"]"};var
K=jsx3.Exception;p.init=function(f){this.jsxsuper(null,true);this.p6=f;};p.get=function(f){var
pa=this.p6[f];return pa!=null?new
...
l(arguments.length>1?this.p6.slice(n,b):this.p6.slice(n));};p.toString=function(){return ub.b+this.toArray()+ub.c;};p.clone=function(){return new
l(this.p6.concat());};p.toArray=function(){var
Mb=this.size();var
Ya=new
Array(Mb);for(var
na=0;na<Mb;na++)Ya[na]=this.get(na);return Ya;};});jsx3.Class.defineClass("jsx3.xml.Entity.ChildIterator",null,[jsx3.util.Iterator],function(r,c){c.init=function(e,d){this.WU=e;this.ty=0;this.Ny=d;this.i6();this.bW=null;};c.next=function(){if(!this._next)return null;if(this.bW){this.bW.init(this._next);}else this.bW=new
...
cb=gb[this.ty];if(cb.nodeType==1||this.Ny&&(cb.nodeType==3||cb.nodeType==4))this._next=cb;this.ty++;}};});jsx3.Class.defineClass("jsx3.xml.Entity.SelectIterator",null,[jsx3.util.Iterator],function(b,f){f.init=function(s){this.pw=s;this.x2=0;this.bW=null;};f.next=function(){var
ea=this.pw.snapshotItem(this.x2++);if(!ea)return null;if(this.bW){this.bW.init(ea);}else this.bW=new
jsx3.xml.Entity(ea);return this.bW;};f.hasNext=function(){return this.pw&&this.x2<this.pw.snapshotLength;};});jsx3.Collection=jsx3.xml.Entity.List;jsx3.util.Collection=jsx3.Collection;jsx3.Class.defineClass("jsx3.net.Request",null,[jsx3.util.EventDispatcher],function(g,f){var
...
Lb=false;try{if(!this.OJ)g.INSYNC=true;this._request.send(n);if(this.OJ)this.hS=0;else delete this[ub.o];}catch(Kb){this.hS=400;g.Q2(2,jsx3._msg(ub.p,this.eE,jsx3.NativeError.wrap(Kb)));Lb=this;}finally{g.INSYNC=false;}if(this.OJ){if(Lb||this._request.readyState==4){jsx3.sleep(function(){hb.log(ub.q);this.publish({subject:ub.a});},null,this);}else{var
...
ub={A:"//x:parsererror//x:div",B:/[\n\r]/g,C:" ",D:"xml.unknown",E:"1.0",F:"<?xml",G:' version="',H:'"',I:' encoding="',J:' standalone="',K:"yes",L:"no",M:"?>\n",N:"xml",O:"<!-- ",P:" -->",Q:"\n",R:"XPath",S:"xmlns:",T:"='",U:"'",V:"object",W:"([^=]*)=['\"]([^\"^']*)['\"]",X:"g",Y:":",Z:"http://www.w3.org/XML/1998/namespace",_:"undefined",a:"response",aa:"jsx",b:"error",ba:"attribute::* | child::*",c:"timeout",ca:"3.0.0",d:"http://xsd.tns.tibco.com/gi/cxf/2006",e:"jsx_xmlns",f:/xmlns:([^=]*)=['\"]([^\"^']*)['\"]/g,g:"",h:"xml.parser",i:"MV",j:"GET",k:"*",l:"pO",m:"lw",n:"content-type",o:/xml|xsl/i,p:"xml.doc_status",q:"xml.timeout",r:"text/xml",s:"parse",t:"0",u:"xml.err_fmt",v:"xml.doc_bad_ex",w:"xml.doc_bad",x:'<x xmlns:x="http://www.w3.org/1999/xhtml"/>',y:"x",z:"http://www.w3.org/1999/xhtml"};var
...
Ua=this.MV.createProcessingInstruction(k,a);this.MV.appendChild(Ua);};m.setAsync=function(l){this._jsxJF=l;return this;};m.getAsync=function(j){return Boolean(this._jsxJF);};m.setSelectionLanguage=function(b){return this;};m.getSelectionLanguage=function(){return ub.R;};e.Qj=function(j){var
qa=[];for(var Ca in j)qa[qa.length]=ub.S+j[Ca]+ub.T+Ca+ub.U;return qa.join(ub.C);};m.setSelectionNamespaces=function(g){if(typeof g==ub.V)g=e.Qj(g);this.MV._jsxxh=g;this.MV._jsxDc=null;return this;};m.getSelectionNamespaces=function(f){return this.MV._jsxxh?this.MV._jsxxh:ub.g;};m.createNamespaceAxis=function(){var
la=this.getRootNode();var
na=la.toString();var
Na=ub.g;do{var
z=new
RegExp(ub.S+ub.e+Na+ub.W,ub.X);var
cb=na.search(z);if(cb>=0)Na=Na==ub.g?0:Na+1;}while(cb>=0);this.I7(la,ub.e+Na);this.loadXML(this.getXML());return ub.e+Na;};m.I7=function(l,g){var
P=(l.cloneNode(false)).getXML();var
qb;while(qb=e.lP.exec(P))if(RegExp.$1!=g&&RegExp.$1!=ub.N){var
Lb=l.createNode(2,g+ub.Y+RegExp.$1,e.SEARCHABLE_NAMESPACE);Lb.setValue(RegExp.$2);l.setAttributeNode(Lb);}else if(RegExp.$1==ub.N)jsx3.log(P);for(var
Oa=l.getChildIterator();Oa.hasNext();)this.I7(Oa.next(),g);};m.getDeclaredNamespaces=function(l){this._jsxl3={};var
vb=this.getRootNode();if(vb)this.J0(vb,{index:0},l);return this._jsxl3;};m.J0=function(n,q,f){var
Pa=n.getNamespaceURI();if(Pa!=ub.g&&Pa!=ub.Z){var
ja;if(!this._jsxl3[Pa]||f&&(ja=n.getPrefix())!=ub.g&&typeof f[ja]!=ub._)if(ja){this._jsxl3[Pa]=ja;}else{q.index+=1;this._jsxl3[Pa]=ub.aa+q.index;}}if(n.getNodeType()==1)for(var
u=n.selectNodeIterator(ub.ba);u.hasNext();){var
ka=u.next();if(ka.getNodeType()==1||ka.getNodeType()==2)this.J0(ka,q,f);}};m.getNativeDocument=function(){return this.MV;};e.Q2=function(g,i){if(e.dK==null)if(jsx3.util.Logger){e.dK=jsx3.util.Logger.getLogger(e.jsxclass.getName());if(e.dK==null)return;}else return;e.dK.log(g,i);};e.getVersion=function(){return ub.ca;};});jsx3.Document=jsx3.xml.Document;jsx3.Class.defineClass("jsx3.xml.Template",null,null,function(p,s){var
...
ub={a:"end"};var
E=jsx3.html;g.init=function(n){this.dw={elm:n,start:n.selectionStart,end:n.selectionEnd,scrollt:n.scrollTop,scrolll:n.scrollLeft};};g.getStartIndex=function(){return this.dw.start;};g.getEndIndex=function(){return this.dw.end;};g.setRange=function(f,l){this.dw.start=f;this.dw.end=l;this.dw.elm.setSelectionRange(f,l);};g.getOffsetLeft=function(){if(this.dw.pos==null)this.dw.pos=jsx3.html.getRelativePosition(null,this.dw.elm);return this.dw.pos.L;};g.getOffsetTop=function(){if(this.dw.pos==null)this.dw.pos=jsx3.html.getRelativePosition(null,this.dw.elm);return this.dw.pos.T;};g.getText=function(){return this.dw.elm.value.substring(this.dw.start,this.dw.end);};g.setText=function(i){this.dw.elm.value=this.dw.elm.value.substring(0,this.dw.start)+i+this.dw.elm.value.substring(this.dw.end);this.dw.elm.setSelectionRange(this.dw.start,this.dw.start+i.length);this.dw.elm.end=this.dw.elm.selectionEnd;};g.insertCaret=function(r){this.dw.elm.focus();if(r==ub.a){this.dw.elm.setSelectionRange(this.dw.elm.end,this.dw.elm.end);}else throw new
