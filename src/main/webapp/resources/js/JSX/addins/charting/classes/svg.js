...
ub={A:"');",a:"px",b:"yp",c:"http://www.w3.org/2000/svg",d:"evt",e:"number",f:"#",g:"",h:/^\s*(.*?)\s*$/,i:"$1",j:/[^\d\.]/g,k:/[^\d\.]/,l:"on",m:"_",n:"onclick",o:"if(evt.detail%2==0){if(this.getAttribute('_dblclick'))jsx3.GO('",p:"').",q:"(evt,this,this.getAttribute('_dblclick'));}",r:"else{if(this.getAttribute('_click'))",s:"jsx3.GO('",t:"(evt,this,this.getAttribute('_click'));}",u:/\"/g,v:"&quot;",w:/;\s*$/,x:";",y:"(",z:",this,'"};m._e=ub.a;m.BE=ub.b;m.Th=ub.c;m.QO=ub.d;m.colorAsHtml=function(a){return typeof a==ub.e?ub.f+((a+16777216).toString(16)).substring(1):ub.g+a;};m.xf=function(a,j,i){if(a==null)a=0;if(j==null)j=ub.a;if(typeof a==ub.e){return a+ub.g+j;}else{a=a.toString();a=a.replace(ub.h,ub.i);if(i)a=a.replace(ub.j,ub.g);return a.match(ub.k)?a:a+ub.g+j;}};m.Tb=function(s){return Math.max(0,Math.min(1,s));};m.degreesToRadians=function(b){return jsx3.util.numMod(2*Math.PI/360*(-1*b+90),2*Math.PI);};m.paintEventHandler=function(o,n,f,j){var
Ta=ub.l+n;var
...
ub={a:"title",b:"can't append ",c:" to ",d:", already has parent ",e:"Illegal to append child ",f:" to parent ",g:"."};a.init=function(l,g,m,d,k){this.jsxsuper(jsx3.vector.Th,l,g,m,d,k);};a.getToolTip=function(){return this.getProperty(ub.a);};a.setToolTip=function(d){this.setProperty(ub.a,d);};a.setRotation=function(p){this.cM=p;};a.setLeft=function(c){this.uY=c;};a.setTop=function(d){this.PS=d;};a.setWidth=function(m){this.Vv=m;};a.setHeight=function(l){this.rz=l;};a.setPosition=function(k){this.cQ=k;};a.getRotation=function(){return this.cM;};a.getLeft=function(){return this.uY;};a.getTop=function(){return this.PS;};a.getWidth=function(){return this.Vv;};a.getHeight=function(){return this.rz;};a.getPosition=function(){return this.cQ;};a.setZIndex=function(q){this.jsxsuper(q);var
...
ga=jsx3.vector;c.dk=null;b.init=function(e,m){this.jsxsuper(ga.Th,c.dk);this.VH=null;this.tU=e!=null?e:0;this.jM=m!=null?ga.Tb(m):1;this.Tr=null;this.B9=null;this.B0=null;this.j3=null;this.ZU=null;};b.getColor=function(){return this.tU;};b.getColorHtml=function(){return ga.colorAsHtml(this.tU);};b.setColor=function(s){this.tU=s;};b.getAlpha=function(){return this.jM;};b.setAlpha=function(l){this.jM=l!=null?ga.Tb(l):null;};b.getType=function(){return this.Tr;};b.setType=function(g){this.Tr=g;};b.getColor2=function(){return this.B9;};b.getColor2Html=function(){return ga.colorAsHtml(this.B9);};b.setColor2=function(n){this.B9=n;};b.getAlpha2=function(){return this.B0;};b.setAlpha2=function(m){this.B0=m;};b.getAngle=function(){return this.j3;};b.setAngle=function(l){this.j3=l;};b.getColors=function(){return this.ZU;};b.setColors=function(l){this.ZU=l;};b.toString=function(){return ub.a+this.getColorHtml()+ub.b+this.getAlpha()+ub.c;};b.hasGradient=function(){return this.Tr&&this.Tr!=ub.d;};b.Aj=function(){return (this.jM==1||this.jM==null)&&!this.hasGradient();};c.valueOf=function(n){if(jsx3.util.strEmpty(n))return null;if(n instanceof c)return n;var
...
ya=new
L.Rectangle(A,U,ka,aa);ya.setZIndex(n.FA);Nb.appendChild(ya);var
