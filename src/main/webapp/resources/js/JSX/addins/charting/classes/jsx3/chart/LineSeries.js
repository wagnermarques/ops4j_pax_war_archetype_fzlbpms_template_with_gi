...
ub={a:"segment",b:"step",c:"reverseStep",d:"horizontal",e:"vertical",f:"jsx3.chart.LineSeries.tooltip",g:"form",h:"pointRenderer",i:"Vf",j:"hk",k:"_line",l:"_p",m:"jsxid",n:"bad LineSeries form: ",o:"Xf",p:"{",q:",",r:"}"};var
Db=jsx3.vector;c.FORM_SEGMENT=ub.a;c.FORM_STEP=ub.b;c.FORM_REVSTEP=ub.c;c.FORM_HORIZONTAL=ub.d;c.FORM_VERTICAL=ub.e;c.GB={segment:1,step:1,reverseStep:1,horizontal:1,vertical:1};c.HQ=4;c.Ur=function(n){this.series=n;};c.Ur.prototype.render=function(p,d,o,r,q,n){var
E=o-p;var
Na=r-d;var
aa=new
...
jsx3.IllegalArgumentException(ub.g,r);};h.getInterpolateValues=function(){return this.interpolateValues;};h.setInterpolateValues=function(j){this.interpolateValues=j;};h.getPointRadius=function(){return this.pointRadius!=null?this.pointRadius:c.HQ;};h.setPointRadius=function(s){this.pointRadius=s;};h.getPointRenderer=function(){return jsx3.chart.Sl(this,ub.h);};h.setPointRenderer=function(a){jsx3.chart.yd(this,ub.h,a);};h.getPointFill=function(){return this.pointFill;};h.setPointFill=function(r){this.pointFill=r;};h.getPointStroke=function(){return this.pointStroke;};h.setPointStroke=function(f){this.pointStroke=f;};h.getPointGradient=function(){return this.pointGradient;};h.setPointGradient=function(j){this.pointGradient=j;};h.Mf=function(){var
